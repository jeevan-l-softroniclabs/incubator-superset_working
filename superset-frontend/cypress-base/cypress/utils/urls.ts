...
export const WORLD_HEALTH_DASHBOARD = '/datadissection/dashboard/world_health/';
export const SAMPLE_DASHBOARD_1 = '/datadissection/dashboard/1-sample-dashboard/';
export const SUPPORTED_CHARTS_DASHBOARD =
  '/datadissection/dashboard/supported_charts_dash/';
export const TABBED_DASHBOARD = '/datadissection/dashboard/tabbed_dash/';
