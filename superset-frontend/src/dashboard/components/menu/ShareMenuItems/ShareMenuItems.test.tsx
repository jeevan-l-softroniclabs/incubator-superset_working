...
const createProps = () => ({
  ...
  url: `/datadissection/dashboard/${DASHBOARD_ID}`,
...
beforeAll((): void => {
  ...
  fetchMock.post(
    ...
    { key: '123', url: 'http://localhost/datadissection/dashboard/p/123/' },
    {
      sendAsJson: true,
    },
  );
...
test('Click on "Copy dashboard URL" and succeed', async () => {
  ...
  await waitFor(async () => {
    ...
    expect(value).toBe('http://localhost/datadissection/dashboard/p/123/');
