...
describe('exploreUtils', () => {
  ...
  describe('getExploreUrl', () => {
    ...
    it('generates proper json url', () => {
      ...
      compareURI(URI(url), URI('/datadissection/explore_json/'));
    });
    it('generates proper json forced url', () => {
      ...
      compareURI(
        URI(url),
        URI('/datadissection/explore_json/').search({ force: 'true' }),
      );
    });
    it('generates proper csv URL', () => {
      ...
      compareURI(
        URI(url),
        URI('/datadissection/explore_json/').search({ csv: 'true' }),
      );
    });
    ...
    it('preserves main URLs params', () => {
      ...
      compareURI(
        URI(url),
        URI('/datadissection/explore_json/').search({ foo: 'bar' }),
      );
    });
