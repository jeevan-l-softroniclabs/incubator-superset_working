...
class Superset(BaseSupersetView):  # pylint: disable=too-many-public-methods
    ...
    def request_access(self) -> FlaskResponse:
        ...
        if has_access_:
            return redirect("/datadissection/dashboard/{}".format(dashboard_id))
    ...
    def get_redirect_url() -> str:
        ...
        to the cache layer.
        """
        redirect_url = request.url.replace("/datadissection/explore", "/explore")
        form_data_key = None
    ...
    def fave_dashboards(self, user_id: int) -> FlaskResponse:
        ...
        for o in qry.all():
            ...
            if o.Dashboard.created_by:
                ...
                dash["creator_url"] = "/datadissection/profile/{}/".format(user.username)
            payload.append(dash)
        return json_success(json.dumps(payload, default=utils.json_int_dttm_ser))
    ...
    def dashboard_permalink(  # pylint: disable=no-self-use
        ...
        url = f"/datadissection/dashboard/{dashboard_id}?permalink_key={key}"
    ...
    def search_queries(self) -> FlaskResponse:  # pylint: disable=no-self-use
        ...
        page /datadissection/sqllab#search.
