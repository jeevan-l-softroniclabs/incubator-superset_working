...
class Slice(  # pylint: disable=too-many-public-methods
    ...
    def explore_json_url(self) -> str:
        """Defines the url to access the slice"""
        return self.get_explore_url("/datadissection/explore_json")
    ...
    def created_by_url(self) -> str:
        if not self.created_by:
            return ""
        return f"/datadissection/profile/{self.created_by.username}"
    ...
    def changed_by_url(self) -> str:
        if (
            ...
            return ""
        return f"/datadissection/profile/{self.changed_by.username}"
