...
EXPLORE_DASHBOARD_LINK = "http://localhost:9000/datadissection/dashboard/3/?standalone=3"
...
def test_convert_dashboard_link() -> None:
    ...
    assert test_url == "http://localhost:9000/datadissection/dashboard/3/?standalone=0"
