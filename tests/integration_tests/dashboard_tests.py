...
class TestDashboard(SupersetTestCase):
    ...
    def test_public_user_dashboard_access(self):
        ...
        self.assertNotIn("/datadissection/dashboard/births/", resp)
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn("/datadissection/dashboard/births/", resp)
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertNotIn("/datadissection/dashboard/world_health/", resp)
    ...
    def test_dashboard_with_created_by_can_be_accessed_by_public_users(self):
        ...
        res: Response = self.client.get("/datadissection/dashboard/births/")
    ...
    def test_users_can_list_published_dashboard(self):
        self.login("alpha")
        resp = self.get_resp("/api/v1/dashboard/")
        assert f"/datadissection/dashboard/{pytest.hidden_dash_slug}/" not in resp
        assert f"/datadissection/dashboard/{pytest.published_dash_slug}/" in resp
    ...
    def test_users_can_view_own_dashboard(self):
        ...
        self.assertIn(f"/datadissection/dashboard/{my_dash_slug}/", resp)
        self.assertNotIn(f"/datadissection/dashboard/{not_my_dash_slug}/", resp)
    ...
    def test_users_can_view_favorited_dashboards(self):
        ...
        self.assertIn(f"/datadissection/dashboard/{fav_dash_slug}/", resp)
    ...
    def test_user_can_not_view_unpublished_dash(self):
        ...
        self.assertNotIn(f"/datadissection/dashboard/{slug}/", resp)
