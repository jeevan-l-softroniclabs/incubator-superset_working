...
class TestDashboardApi(SupersetTestCase, ApiOwnersTestCaseMixin, InsertChartMixin):
    ...
    def test_get_dashboard(self):
        ...
        with override_user(admin):
            expected_result = {
                ...
                "position_json": "",
                "published": False,
                "url": "/datadissection/dashboard/slug1/",
                "slug": "slug1",
                "tags": [],
        ...
        expected_results = [
            {
                ...
                "url": "/datadissection/dashboard/create_slug1/",
            },
            {
                "dashboard_title": "create_title0",
                "url": "/datadissection/dashboard/create_slug0/",
            },
        ]
    ...
    def test_dashboard_activity_access_enabled(self):
        ...
        self.assertEqual(model.dashboard_title, "title2")
        self.assertEqual(model.changed_by_url, "/datadissection/profile/admin")
